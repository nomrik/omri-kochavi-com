    ...
    return (
        <div className="flex flex-row">
            <div class="flex-grow p-10 flex flex-col justify-center items-center">
              ...
              <iframe className="w-full md:w-1/2 aspect-video" src="https://www.youtube.com/embed/uqwlIsPtlgg?si=NRl_iXO3Jl_E5bef&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
